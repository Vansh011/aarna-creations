...
export default function AboutPage() {
  return (
    <div className="bg-ivory">
      <section className="relative overflow-hidden px-4 py-12 text-ivory sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="mt-4 max-w-4xl font-serif text-[2.05rem] leading-[1.02] text-white sm:mt-5 sm:text-[2.75rem] md:text-[3.75rem]">
            A women-driven boutique with a personal eye.
          </h1>
          <p className="mt-4 max-w-2xl font-serif text-base leading-6 text-ivory/88 sm:mt-5 sm:text-xl sm:leading-7">
      ...
      <section className="px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-20">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-12">
          <div>
            ...
            <h2 className="mt-4 font-serif text-[1.85rem] leading-tight text-[#7a1026] sm:mt-5 sm:text-[2.4rem] md:text-[3rem]">
              Started at home. Built with trust.
            </h2>
            <div className="mt-5 space-y-4 text-sm leading-7 text-ink/76 sm:mt-6 sm:space-y-5 sm:text-base sm:leading-8">
              <p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="relative min-h-[310px] overflow-hidden bg-maroon shadow-[0_18px_48px_rgba(78,19,37,0.13)] sm:row-span-2 sm:min-h-[420px] sm:shadow-[0_26px_70px_rgba(78,19,37,0.16)]">
            ...
            {gallery.slice(1).map((item) => (
              <div key={item.title} className="relative min-h-[185px] overflow-hidden bg-maroon shadow-[0_18px_45px_rgba(78,19,37,0.12)] sm:min-h-[202px]">
      ...
      <section className="bg-[#f4eadb] px-4 py-12 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 max-w-3xl sm:mb-10">
            <p className="ornate-title text-[#6d1022]">What guides us</p>
            <h2 className="mt-5 font-serif text-[1.9rem] leading-tight text-[#7a1026] sm:mt-7 sm:text-4xl md:text-5xl">
              Curation with feeling, not noise.
            </h2>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="border border-gold/25 bg-ivory p-5 shadow-[0_18px_50px_rgba(78,19,37,0.08)] sm:p-7">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-6 border border-gold/25 bg-[#4a0f20] p-5 text-ivory shadow-[0_24px_64px_rgba(78,19,37,0.14)] sm:gap-8 sm:p-7 md:grid-cols-[1fr_auto] md:items-center md:p-10">
          <div>
            ...
            <h2 className="mt-4 font-serif text-[1.9rem] leading-tight text-white sm:mt-5 sm:text-4xl md:text-5xl">
              Begin your journey with us.
            </h2>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-ivory/76 sm:mt-4 sm:text-base sm:leading-7">
